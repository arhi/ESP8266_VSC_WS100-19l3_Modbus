...
class ModBusRTU
{
  public:
    ...
    */
    ...
    /**
    ModBusRTU invalid response slave ID exception.
    ...
    */
    ...
    /**
    ModBusRTU invalid response function exception.
    ...
    */
    ...
    /**
    ModBusRTU response timed out exception.
    
    The entire response was not received within the timeout period, 
    ModBusRTU::ku8MBResponseTimeout. 
    ...
    */
    ...
    /**
    ModBusRTU invalid response CRC exception.
    ...
    */
    ...
    uint8_t  readRaw(uint8_t, uint8_t, uint16_t, uint16_t);
    void     snprintResult(char *, size_t, uint8_t);
  ...
  private:
    ...
    uint8_t ModBusRTUTransaction(uint8_t u8MBFunction);
